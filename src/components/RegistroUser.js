    ...
    <div className='page-container'>              
       ...
       <Form onSubmit={handleRegistro}>
            ...
            <Form.Group as={Row} className="mb-3" controlId="formHorizontalPassword">
                <Col sm={10}>
                <Form.Control type="password" placeholder="Contraseña" name='pass1' value={pass1} onChange={handleInputChange} />
                </Col>
            </Form.Group>

            <Form.Group as={Row} className="mb-3">
                <Col sm={10}>
                <Form.Control type="password" placeholder="Confirmar Contraseña" name='pass2' value={pass2} onChange={handleInputChange} />
                </Col>
            </Form.Group>
